...
public interface DynamicDatabaseManager {
	 ...
	 * @return null if operation is successful, errorDescription if operation
	 *         failed;
	 */
	...
	/**
	 * @param tableId
	 * @return list of columns with their labels (html and plain) + information about their grouping
	 */
