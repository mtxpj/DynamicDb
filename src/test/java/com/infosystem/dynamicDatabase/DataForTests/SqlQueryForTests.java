...
public class SqlQueryForTests {
	public final String CREATE_DB = "CREATE DATABASE "
			+ DataForTests.getTestDb() + ";";
	public final String DROP_DB = "DROP DATABASE " + DataForTests.getTestDb()
			+ ";";
	public final String USE_DB = "USE " + DataForTests.getTestDb();

	public final String CREATE_BOOLEAN_TABLE = "CREATE TABLE boolean"
			+ "(\nb_id INT NOT NULL AUTO_INCREMENT,\n"
			+ "options VARCHAR(5) NOT NULL,\n"
			+ "PRIMARY KEY ( b_id )\n) DEFAULT CHARSET=utf8;";
	public final String FILL_BOOLEAN_DB = "INSERT INTO boolean (options)\n"
			+ "VALUES (\"true\"),(\"false\");";

	public final String CREATE_DATATYPES_TABLE = "CREATE TABLE data_types"
			+ "(\ndt_id INT NOT NULL AUTO_INCREMENT,\n"
			+ "value VARCHAR(16) NOT NULL,\n"
			+ "PRIMARY KEY ( dt_id )\n) DEFAULT CHARSET=utf8;";
	public final String FILL_DATATYPES_DB = "INSERT INTO data_types (value)\n"
			+ "VALUES (\"STRING\"),(\"DATE\"),(\"NUMBER\"),(\"PREDEFINED_VALUE\"),(\"SUB_SET\");";

	public final String CREATE_TABLE_STORING_TABLES = "CREATE TABLE "
			+ DataForTests.getTablesTableName()
			+ "(\nt_id INT NOT NULL AUTO_INCREMENT,\n"
			+ "table_id VARCHAR(100) NOT NULL,\n"
			+ "PRIMARY KEY ( t_id )\n) DEFAULT CHARSET=utf8;";

	public final String CREATE_TABLE_STORING_COLUMNS = "CREATE TABLE "
	...
	public final String CREATE_PERSONS_TABLE = "CREATE TABLE persons"
	...
	public final String FILL_TABLE = ";";

	@BeforeClass
	public void createDbs() throws SQLException {
